 ...
 */
@Controller
public class CanonicalSolveController {
    ...
    @RequestMapping(value = {"/solve/canonical"}, method = RequestMethod.GET)
    public String getSolve(Model model){
        model.addAttribute("problem",new Problem());
        model.addAttribute("properties",properties);
        return "/solvers/canonicalpso";
    }

    @RequestMapping(value = {"/solve/canonical/{type}"}, method = RequestMethod.GET)
    public String getSolve(@PathVariable("type") String type,Model model)throws Exception{
        return "redirect:/solve/canonical";
    }

    @RequestMapping(value = {"/solve/canonical/protocol"}, method = RequestMethod.GET)
    public ModelAndView getProtocol(Model model){
        return new ModelAndView(new ProtocolExcelView(),"protocols",protocols);
    }

    @RequestMapping(value = {"/solve/properties/canonical"}, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {"/solve/properties/canonical"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {"/solve/canonical/{type}"}, method = RequestMethod.POST)
